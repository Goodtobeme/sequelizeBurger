...
router.get("/burgers", function(req, res) {
	Burger.findAll({ include: { model: Customer } }).then(function(
		burger_data
	) {
...
router.put("/burgers/update", function(req, res) {
	...
	Customer.create({ customer: req.body.customer }).then(function(
		...
		return Burger.findOne({ where: { id: req.body.burger_id } }).then(
			function(theBurger) {
				return theBurger.setCustomer(theCustomer).then(function() {
					return theBurger
						.updateAttributes({
							devoured: true
						})
